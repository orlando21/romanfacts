...
var FACTS = [
    ...
    "The emperor Hadrian built the Temple of Roma and Venus, the largest temple in Rome. The temple's name, Roma, is also a reference to amor spelled backwards, and places the divinities of Rome and Venus back to back in a single temple.",
    ...
    "The legend of Rome's founding is detailed in the epic poem, The Aeneid, written by Virgil between 29 and 19 B.C.",
    ...
    "After driving out Tarquin the Proud, the last king of Rome in 509 B.C., Romans established the Republic and detested the thought of being ruled by a king.",
    ...
    "The early wealth of Rome was partly based on its proximity to salt trade routes, and words like salary reflect the association of salt with money.",
    "The Romans were fascinated by Egypt and Augustus' ambitious building program included the costly transportation of a number of ancient Egyptian obelisks by land and sea. These obelisks can still be seen in Rome and other cities.",
    ...
    "The Mausoleum of Galla Placidia in Ravenna, Italy, is a UNESCO world heritage site but it's unclear whether it really was her final resting place.",
    ...
    "Under Roman law, women inherited and disposed of property as men did, and could run businesses.",
    ...
    "The Byzantine empress Theodora, who reigned with her husband Justinian the first, played a decisive role in putting down the Nika riots of 532 C.E. in the Hippodrome of Constantinople. When the rioters swarmed in numbers and began burning the city, she stood firm and pronounced, royal purple is the noblest shroud. This changed the emperors' mind about fleeing and the government stood firm.",
    ...
    "In 312 B.C. the censor Appius Claudius started construction of his namesake road from Rome to the south. This heralded the dawn of an extensive road network that would enable Roman military and economic domination of the areas it occupied.",
    ...
    "Workers building Trajan's Forum in 112 C.E. had to dig through the sides of the Quirinal and Capitoline Hills to make way for the vast comlex of 150 shops, where goods from flowers and vegetables to fish in saltwater tanks would be sold.",
...
Fact.prototype.intentHandlers = {
    ...
    "AMAZON.HelpIntent": function (intent, session, response) {
        response.ask("You can say tell me a Roman fact, or, you can say exit... What can I help you with?", "What can I help you with?");
    },
